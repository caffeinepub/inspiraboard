...
import type { Author as _Author, ExternalBlob as _ExternalBlob, PostMetadata as _PostMetadata, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPost(arg0: string, arg1: ExternalBlob, arg2: Array<string>): Promise<PostMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.addPost(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1), arg2);
                return from_candid_PostMetadata_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getFeed(): Promise<Array<PostMetadata>> {
        if (this.processError) {
            try {
    ...
    async searchPosts(arg0: string, arg1: string | null): Promise<Array<PostMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchPosts(arg0, to_candid_opt_n25(this._uploadFile, this._downloadFile, arg1));
                return from_candid_vec_n22(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Author_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Author): Promise<Author> {
...
async function from_candid_PostMetadata_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PostMetadata): Promise<PostMetadata> {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        tags: value.tags,
        author: await from_candid_Author_n11(_uploadFile, _downloadFile, value.author),
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PostMetadata>): Promise<Array<PostMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PostMetadata_n9(_uploadFile, _downloadFile, x)));
}
